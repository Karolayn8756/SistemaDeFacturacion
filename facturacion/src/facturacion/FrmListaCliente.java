...
public class FrmListaCliente extends JDialog {
	...
	public FrmListaCliente(Dialog owner, boolean modal, JLabel lblCedula, JLabel lblNombres, JLabel lblApellidos, JLabel lblTelefono, JLabel lblEmail, JLabel lblDireccion) {
		super(owner, modal);
