...
public class FrmProducto extends JInternalFrame {
	...
	public FrmProducto() {
		...
		JLabel lblIdProducto = new JLabel("Cod");
		lblIdProducto.setBackground(new Color(255, 128, 192));
		lblIdProducto.setFont(new Font("Sitka Text", Font.BOLD, 15));
		lblIdProducto.setBounds(10, 25, 118, 19);
		getContentPane().add(lblIdProducto);
		
		JLabel lblDescripcion = new JLabel("Descripción");
		lblDescripcion.setFont(new Font("Sitka Text", Font.BOLD, 15));
		lblDescripcion.setBounds(10, 54, 99, 28);
		getContentPane().add(lblDescripcion);
		
		JLabel lblPrecio = new JLabel("Precio");
		lblPrecio.setFont(new Font("Sitka Text", Font.BOLD, 15));
		lblPrecio.setBounds(10, 92, 88, 30);
		getContentPane().add(lblPrecio);
		
		JLabel lblCantidad = new JLabel("Cantidad");
		lblCantidad.setFont(new Font("Sitka Text", Font.BOLD, 15));
		lblCantidad.setBounds(10, 132, 88, 28);
		getContentPane().add(lblCantidad);
		
		txtIdProducto = new JTextField();
		txtIdProducto.setBounds(119, 23, 260, 20);
		getContentPane().add(txtIdProducto);
		txtIdProducto.setColumns(10);
		
		txtDescripcion = new JTextField();
		txtDescripcion.setColumns(10);
		txtDescripcion.setBounds(119, 54, 260, 20);
		getContentPane().add(txtDescripcion);
		
		txtPrecio = new JTextField();
		txtPrecio.setColumns(10);
		txtPrecio.setBounds(119, 96, 260, 20);
		getContentPane().add(txtPrecio);
		
		txtCantidad = new JTextField();
		txtCantidad.setColumns(10);
		txtCantidad.setBounds(119, 135, 260, 20);
		...
		btnGuardar.setBackground(new Color(255, 128, 192));
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"Cod", "Detalle\u00F3n", "Precio", "Cantidad", "Total"
			}
		));
